...
/**
 * This is the item provider adapter for a {@link org.apache.maven.pom400.ReportSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReportSetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPORT_SET__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPORT_SET__INHERITED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mavenPackage.Literals.REPORT_SET__CONFIGURATION);
			childrenFeatures.add(mavenPackage.Literals.REPORT_SET__REPORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.REPORT_SET__CONFIGURATION,
				 mavenFactory.eINSTANCE.createConfigurationType1()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.REPORT_SET__REPORTS,
				 mavenFactory.eINSTANCE.createReportsType()));
	}
