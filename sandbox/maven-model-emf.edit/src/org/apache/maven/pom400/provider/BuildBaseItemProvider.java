...
/**
 * This is the item provider adapter for a {@link org.apache.maven.pom400.BuildBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildBaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.BUILD_BASE__DEFAULT_GOAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.BUILD_BASE__DIRECTORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.BUILD_BASE__FINAL_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mavenPackage.Literals.BUILD_BASE__RESOURCES);
			childrenFeatures.add(mavenPackage.Literals.BUILD_BASE__TEST_RESOURCES);
			childrenFeatures.add(mavenPackage.Literals.BUILD_BASE__FILTERS);
			childrenFeatures.add(mavenPackage.Literals.BUILD_BASE__PLUGIN_MANAGEMENT);
			childrenFeatures.add(mavenPackage.Literals.BUILD_BASE__PLUGINS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.BUILD_BASE__RESOURCES,
				 mavenFactory.eINSTANCE.createResourcesType()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.BUILD_BASE__TEST_RESOURCES,
				 mavenFactory.eINSTANCE.createTestResourcesType()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.BUILD_BASE__FILTERS,
				 mavenFactory.eINSTANCE.createFiltersType()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.BUILD_BASE__PLUGIN_MANAGEMENT,
				 mavenFactory.eINSTANCE.createPluginManagement()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.BUILD_BASE__PLUGINS,
				 mavenFactory.eINSTANCE.createPluginsType()));
	}
