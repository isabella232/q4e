...
/**
 * This is the item provider adapter for a {@link org.apache.maven.pom400.Activation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.ACTIVATION__ACTIVE_BY_DEFAULT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.ACTIVATION__JDK,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mavenPackage.Literals.ACTIVATION__OS);
			childrenFeatures.add(mavenPackage.Literals.ACTIVATION__PROPERTY);
			childrenFeatures.add(mavenPackage.Literals.ACTIVATION__FILE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.ACTIVATION__OS,
				 mavenFactory.eINSTANCE.createActivationOS()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.ACTIVATION__PROPERTY,
				 mavenFactory.eINSTANCE.createActivationProperty()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.ACTIVATION__FILE,
				 mavenFactory.eINSTANCE.createActivationFile()));
	}
