...
/**
 * This is the item provider adapter for a {@link org.apache.maven.pom400.Plugin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PluginItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.PLUGIN__GROUP_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.PLUGIN__ARTIFACT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.PLUGIN__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.PLUGIN__EXTENSIONS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.PLUGIN__INHERITED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mavenPackage.Literals.PLUGIN__EXECUTIONS);
			childrenFeatures.add(mavenPackage.Literals.PLUGIN__DEPENDENCIES);
			childrenFeatures.add(mavenPackage.Literals.PLUGIN__GOALS);
			childrenFeatures.add(mavenPackage.Literals.PLUGIN__CONFIGURATION);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.PLUGIN__EXECUTIONS,
				 mavenFactory.eINSTANCE.createExecutionsType()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.PLUGIN__DEPENDENCIES,
				 mavenFactory.eINSTANCE.createDependenciesType3()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.PLUGIN__GOALS,
				 mavenFactory.eINSTANCE.createGoalsType()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.PLUGIN__CONFIGURATION,
				 mavenFactory.eINSTANCE.createConfigurationType2()));
	}
