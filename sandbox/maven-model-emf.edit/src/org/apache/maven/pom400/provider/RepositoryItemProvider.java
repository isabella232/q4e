...
/**
 * This is the item provider adapter for a {@link org.apache.maven.pom400.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPOSITORY__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPOSITORY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPOSITORY__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 mavenPackage.Literals.REPOSITORY__LAYOUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mavenPackage.Literals.REPOSITORY__RELEASES);
			childrenFeatures.add(mavenPackage.Literals.REPOSITORY__SNAPSHOTS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.REPOSITORY__RELEASES,
				 mavenFactory.eINSTANCE.createRepositoryPolicy()));

		newChildDescriptors.add
			(createChildParameter
				(mavenPackage.Literals.REPOSITORY__SNAPSHOTS,
				 mavenFactory.eINSTANCE.createRepositoryPolicy()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			childFeature == mavenPackage.Literals.REPOSITORY__RELEASES ||
			childFeature == mavenPackage.Literals.REPOSITORY__SNAPSHOTS;
