 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.PluginsType#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getPluginsType()
...
public interface PluginsType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getPluginsType_Plugin()
