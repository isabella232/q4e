 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.FiltersType#getFilter <em>Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getFiltersType()
...
public interface FiltersType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getFiltersType_Filter()
