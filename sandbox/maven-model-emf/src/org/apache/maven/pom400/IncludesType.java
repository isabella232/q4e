 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.IncludesType#getInclude <em>Include</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getIncludesType()
...
public interface IncludesType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getIncludesType_Include()
