 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.ExcludesTypeImpl#getExclude <em>Exclude</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExcludesTypeImpl extends EObjectImpl implements ExcludesType {
	...
	public EList getExclude() {
		if (exclude == null) {
			exclude = new EDataTypeEList(String.class, this, mavenPackage.EXCLUDES_TYPE__EXCLUDE);
		}
		return exclude;
	}
