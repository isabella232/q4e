 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.PluginsTypeImpl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsTypeImpl extends EObjectImpl implements PluginsType {
	...
	public EList getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList(Plugin.class, this, mavenPackage.PLUGINS_TYPE__PLUGIN);
		}
		return plugin;
	}
