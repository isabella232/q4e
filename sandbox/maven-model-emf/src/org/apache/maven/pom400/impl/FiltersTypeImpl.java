 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.FiltersTypeImpl#getFilter <em>Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FiltersTypeImpl extends EObjectImpl implements FiltersType {
	...
	public EList getFilter() {
		if (filter == null) {
			filter = new EDataTypeEList(String.class, this, mavenPackage.FILTERS_TYPE__FILTER);
		}
		return filter;
	}
