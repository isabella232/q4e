 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.PluginsType2Impl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsType2Impl extends EObjectImpl implements PluginsType2 {
	...
	public EList getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList(Plugin.class, this, mavenPackage.PLUGINS_TYPE2__PLUGIN);
		}
		return plugin;
	}
