 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.RepositoriesTypeImpl#getRepository <em>Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoriesTypeImpl extends EObjectImpl implements RepositoriesType {
	...
	public EList getRepository() {
		if (repository == null) {
			repository = new EObjectContainmentEList(Repository.class, this, mavenPackage.REPOSITORIES_TYPE__REPOSITORY);
		}
		return repository;
	}
