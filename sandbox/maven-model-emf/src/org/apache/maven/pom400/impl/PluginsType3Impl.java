 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.PluginsType3Impl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsType3Impl extends EObjectImpl implements PluginsType3 {
	...
	public EList getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList(Plugin.class, this, mavenPackage.PLUGINS_TYPE3__PLUGIN);
		}
		return plugin;
	}
