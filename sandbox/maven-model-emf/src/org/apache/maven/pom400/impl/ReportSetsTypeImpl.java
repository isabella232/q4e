 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.ReportSetsTypeImpl#getReportSet <em>Report Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReportSetsTypeImpl extends EObjectImpl implements ReportSetsType {
	 ...
	 * @ordered
	 */
	protected EList reportSet = null;
	 ...
	 * @generated
	 */
	public EList getReportSet() {
		if (reportSet == null) {
			reportSet = new EObjectContainmentEList(ReportSet.class, this, mavenPackage.REPORT_SETS_TYPE__REPORT_SET);
		}
		return reportSet;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case mavenPackage.REPORT_SETS_TYPE__REPORT_SET:
				getReportSet().clear();
				getReportSet().addAll((Collection)newValue);
				return;
		}
