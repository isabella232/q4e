 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.impl.ExclusionsTypeImpl#getExclusion <em>Exclusion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExclusionsTypeImpl extends EObjectImpl implements ExclusionsType {
	 ...
	 * @ordered
	 */
	protected EList exclusion = null;
	...
	public EList getExclusion() {
		if (exclusion == null) {
			exclusion = new EObjectContainmentEList(Exclusion.class, this, mavenPackage.EXCLUSIONS_TYPE__EXCLUSION);
		}
		return exclusion;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case mavenPackage.EXCLUSIONS_TYPE__EXCLUSION:
				getExclusion().clear();
				getExclusion().addAll((Collection)newValue);
				return;
		}
