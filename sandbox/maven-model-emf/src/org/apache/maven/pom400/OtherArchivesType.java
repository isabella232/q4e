 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.OtherArchivesType#getOtherArchive <em>Other Archive</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getOtherArchivesType()
...
public interface OtherArchivesType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getOtherArchivesType_OtherArchive()
