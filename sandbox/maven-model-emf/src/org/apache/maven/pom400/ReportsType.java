 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.ReportsType#getReport <em>Report</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getReportsType()
...
public interface ReportsType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getReportsType_Report()
