 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.PluginRepositoriesType1#getPluginRepository <em>Plugin Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getPluginRepositoriesType1()
...
public interface PluginRepositoriesType1 extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getPluginRepositoriesType1_PluginRepository()
