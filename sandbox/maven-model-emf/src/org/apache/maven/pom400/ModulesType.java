 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.ModulesType#getModule <em>Module</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getModulesType()
...
public interface ModulesType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getModulesType_Module()
