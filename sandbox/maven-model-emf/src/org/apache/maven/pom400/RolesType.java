 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.RolesType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getRolesType()
...
public interface RolesType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getRolesType_Role()
