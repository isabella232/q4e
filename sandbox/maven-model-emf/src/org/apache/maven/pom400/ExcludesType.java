 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom400.ExcludesType#getExclude <em>Exclude</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.apache.maven.pom400.mavenPackage#getExcludesType()
...
public interface ExcludesType extends EObject {
	 ...
	 * @see org.apache.maven.pom400.mavenPackage#getExcludesType_Exclude()
