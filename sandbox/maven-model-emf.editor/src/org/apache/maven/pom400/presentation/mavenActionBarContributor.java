...
public class mavenActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(MavenEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(MavenEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MavenEditorPlugin.INSTANCE.getString("_UI_mavenEditor_menu"), "org.apache.maven.pom400MenuID");
		...
		//
		createChildMenuManager = new MenuManager(MavenEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(MavenEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
