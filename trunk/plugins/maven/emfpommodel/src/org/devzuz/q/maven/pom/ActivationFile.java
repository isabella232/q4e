...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Activation File</b></em>'. <!--
 * end-user-doc --> <!-- begin-model-doc --> 4.0.0 This is the file specification used to activate the profile. The
 * missing value will be the location of a file that needs to exist, and if it doesn't the profile will be activated. On
 * the other hand exists will test for the existence of the file and if it is there the profile will be activated. <!--
 * end-model-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.ActivationFile#getMissing <em>Missing</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.ActivationFile#getExists <em>Exists</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.devzuz.q.maven.pom.PomPackage#getActivationFile()
    ...
    extends EObject
{
     ...
     * <!-- begin-model-doc --> 4.0.0 The name of the file that must be missing to activate the profile. <!--
     * end-model-doc -->
     * 
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='missing'
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='exists'
     *        namespace='##targetNamespace'"
     * @generated
     */
    String getExists();
