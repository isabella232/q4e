 ...
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getName <em>Name</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getEmail <em>Email</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getUrl <em>Url</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getOrganization <em>Organization</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getOrganizationUrl <em>Organization Url</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getTimezone <em>Timezone</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getProperties <em>Properties</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ContributorImpl#getRoles <em>Roles</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
    ...
    implements Contributor
{
    ...
    public EList<String> getRoles()
    {
        if ( roles == null )
        {
            roles = new EDataTypeUniqueEList.Unsettable<String>( String.class, this, PomPackage.CONTRIBUTOR__ROLES );
        }
        return roles;
    }
