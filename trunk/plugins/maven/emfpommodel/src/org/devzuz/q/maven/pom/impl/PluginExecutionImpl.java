...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Plugin Execution</b></em>'. <!--
 * end-user-doc -->
 * <p>
    ...
    implements PluginExecution
{
    ...
    public void setInherited( String newInherited )
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.PLUGIN_EXECUTION__INHERITED,
                                            oldInherited, inherited ) );
    }
    ...
    public EList<String> getGoals()
    {
        if ( goals == null )
        {
            goals = new EDataTypeUniqueEList<String>( String.class, this, PomPackage.PLUGIN_EXECUTION__GOALS );
        }
        return goals;
    }
