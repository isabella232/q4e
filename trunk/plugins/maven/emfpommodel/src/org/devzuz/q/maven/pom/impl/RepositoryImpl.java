    ...
    implements Repository
{
    ...
    public NotificationChain basicSetReleases( RepositoryPolicy newReleases, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.REPOSITORY__RELEASES, oldReleases,
    ...
    public void setReleases( RepositoryPolicy newReleases )
    {
        if ( newReleases != releases )
        {
            ...
            if ( releases != null )
                msgs =
                    ( (InternalEObject) releases ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.REPOSITORY__RELEASES, null, msgs );
            if ( newReleases != null )
                msgs =
                    ( (InternalEObject) newReleases ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.REPOSITORY__RELEASES, null, msgs );
    ...
    public NotificationChain basicUnsetReleases( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.REPOSITORY__RELEASES, oldReleases, null,
                                       oldReleasesESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicSetSnapshots( RepositoryPolicy newSnapshots, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.REPOSITORY__SNAPSHOTS, oldSnapshots,
    ...
    public void setSnapshots( RepositoryPolicy newSnapshots )
    {
        if ( newSnapshots != snapshots )
        {
            ...
            if ( snapshots != null )
                msgs =
                    ( (InternalEObject) snapshots ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.REPOSITORY__SNAPSHOTS, null, msgs );
            if ( newSnapshots != null )
                msgs =
                    ( (InternalEObject) newSnapshots ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.REPOSITORY__SNAPSHOTS, null, msgs );
    ...
    public NotificationChain basicUnsetSnapshots( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.REPOSITORY__SNAPSHOTS, oldSnapshots, null,
                                       oldSnapshotsESet );
            if ( msgs == null )
                msgs = notification;
            else
