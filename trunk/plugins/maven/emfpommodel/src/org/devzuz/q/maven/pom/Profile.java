 ...
 * <!-- begin-model-doc --> 4.0.0 Modifications to the build process which is activated based on environmental
 * parameters or command line arguments. <!-- end-model-doc -->
 * <p>
    ...
    extends EObject
{
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='id'
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.Profile#getId <em>Id</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     ...
     * @model containment="true" unsettable="true" extendedMetaData="kind='element' name='activation'
     *        namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.Profile#getActivation <em>Activation</em>}' containment
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getActivation <em>Activation</em>}' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetActivation()
     * @see #getActivation()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getActivation <em>Activation</em>}'
     ...
     * end-user-doc --> <!-- begin-model-doc --> 4.0.0 Information required to build the project. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getBuild <em>Build</em>}' containment
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getRepositories <em>Repositories</em>}'
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getRepositories <em>Repositories</em>}'
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getPluginRepositories <em>Plugin Repositories</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetPluginRepositories()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getPluginRepositories <em>Plugin Repositories</em>}'
     * containment reference list is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getDependencies <em>Dependencies</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetDependencies()
     * @see #getDependencies()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getDependencies <em>Dependencies</em>}'
     * containment reference list is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * --> 4.0.0 &lt;b&gt;Deprecated&lt;/b&gt;. Now ignored by Maven. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Reports</em>' containment reference list.
     * @see #isSetReports()
     * @see #unsetReports()
     * @see org.devzuz.q.maven.pom.PomPackage#getProfile_Reports()
     * @model containment="true" unsettable="true" extendedMetaData="kind='element' name='reports'
     *        namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getReports <em>Reports</em>}' containment
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getReports <em>Reports</em>}'
     * containment reference list is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.Profile#getDependencyManagement <em>Dependency Management</em>}'
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getDependencyManagement <em>Dependency Management</em>}'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetDependencyManagement()
     * @see #getDependencyManagement()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getDependencyManagement <em>Dependency Management</em>}'
     * containment reference is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.Profile#getDistributionManagement <em>Distribution Management</em>}'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getDistributionManagement <em>Distribution Management</em>}'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetDistributionManagement()
     * @see #getDistributionManagement()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getDistributionManagement <em>Distribution Management</em>}'
     * containment reference is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.Profile#getProperties <em>Properties</em>}' containment
     * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetProperties()
     * @see #getProperties()
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.Profile#getProperties <em>Properties</em>}'
     * containment reference list is set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
