    ...
    implements Profile
{
    ...
    public NotificationChain basicSetActivation( Activation newActivation, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.PROFILE__ACTIVATION, oldActivation,
    ...
    public void setActivation( Activation newActivation )
    {
        if ( newActivation != activation )
        {
            ...
            if ( activation != null )
                msgs =
                    ( (InternalEObject) activation ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.PROFILE__ACTIVATION, null, msgs );
            if ( newActivation != null )
                msgs =
                    ( (InternalEObject) newActivation ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.PROFILE__ACTIVATION, null, msgs );
    ...
    public NotificationChain basicUnsetActivation( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__ACTIVATION, oldActivation, null,
                                       oldActivationESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicSetBuild( BuildBase newBuild, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.PROFILE__BUILD, oldBuild, newBuild,
                                       !oldBuildESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setBuild( BuildBase newBuild )
    {
        if ( newBuild != build )
        {
            ...
            if ( build != null )
                msgs =
                    ( (InternalEObject) build ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.PROFILE__BUILD, null, msgs );
            if ( newBuild != null )
                msgs =
                    ( (InternalEObject) newBuild ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.PROFILE__BUILD, null, msgs );
    ...
    public NotificationChain basicUnsetBuild( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__BUILD, oldBuild, null,
                                       oldBuildESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void unsetBuild()
    {
        if ( build != null )
        {
            NotificationChain msgs = null;
            msgs =
                ( (InternalEObject) build ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.PROFILE__BUILD,
                                                            null, msgs );
        ...
        else
        {
            ...
            buildESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__BUILD, null, null,
                                                oldBuildESet ) );
        }
    }
    ...
    public EList<ReportPlugin> getReports()
    {
        ...
        {
            reports =
                new EObjectContainmentEList.Unsettable<ReportPlugin>( ReportPlugin.class, this,
                                                           ...
                                                           NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.PROFILE__DEPENDENCY_MANAGEMENT,
    ...
    public NotificationChain basicUnsetDependencyManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__DEPENDENCY_MANAGEMENT,
    ...
    public void unsetDependencyManagement()
    {
        ...
        else
        {
            ...
            dependencyManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__DEPENDENCY_MANAGEMENT,
                                                             ...
                                                             NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.PROFILE__DISTRIBUTION_MANAGEMENT,
    ...
    public NotificationChain basicUnsetDistributionManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__DISTRIBUTION_MANAGEMENT,
    ...
    public void unsetDistributionManagement()
    {
        ...
        else
        {
            ...
            distributionManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.PROFILE__DISTRIBUTION_MANAGEMENT,
    ...
    public EList<String> getModules()
    {
        if ( modules == null )
        {
            modules = new EDataTypeUniqueEList<String>( String.class, this, PomPackage.PROFILE__MODULES );
        }
        return modules;
    }
