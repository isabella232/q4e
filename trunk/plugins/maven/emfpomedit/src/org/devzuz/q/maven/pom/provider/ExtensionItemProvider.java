...
/**
 * This is the item provider adapter for a {@link org.devzuz.q.maven.pom.Extension} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
    ...
    IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addGroupIdPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Extension_groupId_feature",
                                                                              "_UI_Extension_type" ),
                                                                   PomPackage.Literals.EXTENSION__GROUP_ID, true,
                                                                   false, false,
    ...
    protected void addArtifactIdPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              ...
                                                                              "_UI_Extension_type" ),
                                                                   PomPackage.Literals.EXTENSION__ARTIFACT_ID, true,
                                                                   false, false,
                                                                   ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
                                                                   null ) );
    }
    ...
    protected void addVersionPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Extension_version_feature",
                                                                              "_UI_Extension_type" ),
                                                                   PomPackage.Literals.EXTENSION__VERSION, true, false,
