 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginsType2Impl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsType2Impl extends EObjectImpl implements PluginsType2
{
    ...
    {
		if (plugin == null) {
			plugin = new EObjectContainmentEList<Plugin>(Plugin.class, this, PomPackage.PLUGINS_TYPE2__PLUGIN);
		}
		return plugin;
	}
