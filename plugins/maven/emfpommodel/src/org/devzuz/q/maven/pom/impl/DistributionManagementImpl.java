...
public class DistributionManagementImpl
    extends EObjectImpl
    implements DistributionManagement
{
    /**
    ...
    public NotificationChain basicSetRepository( DeploymentRepository newRepository, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY,
    ...
    public void setRepository( DeploymentRepository newRepository )
    {
        if ( newRepository != repository )
        {
            ...
            if ( repository != null )
                msgs =
                    ( (InternalEObject) repository ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, null, msgs );
            if ( newRepository != null )
                msgs =
                    ( (InternalEObject) newRepository ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, null, msgs );
    ...
    public NotificationChain basicUnsetRepository( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY,
        ...
        else
        {
            ...
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                                                PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, null, null,
                                                oldRepositoryESet ) );
        }
    }
                                                         ...
                                                         NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY,
                                       oldSnapshotRepository, newSnapshotRepository, !oldSnapshotRepositoryESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void setSnapshotRepository( DeploymentRepository newSnapshotRepository )
    {
        if ( newSnapshotRepository != snapshotRepository )
        {
            ...
            if ( snapshotRepository != null )
                msgs =
                    ( (InternalEObject) snapshotRepository ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, null, msgs );
            if ( newSnapshotRepository != null )
                msgs =
                    ( (InternalEObject) newSnapshotRepository ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, null, msgs );
    ...
    public void unsetSnapshotRepository()
    {
        ...
        else
        {
            ...
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                                                PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, null, null,
                                                oldSnapshotRepositoryESet ) );
        }
    }
    ...
    public NotificationChain basicSetSite( Site newSite, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, oldSite,
                                       newSite, !oldSiteESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setSite( Site newSite )
    {
        if ( newSite != site )
        {
            ...
            if ( site != null )
                msgs =
                    ( (InternalEObject) site ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__SITE, null, msgs );
            if ( newSite != null )
                msgs =
                    ( (InternalEObject) newSite ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__SITE, null, msgs );
        ...
        else
        {
            ...
            siteESet = true;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE,
                                                newSite, newSite, !oldSiteESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetSite( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, oldSite,
                                       null, oldSiteESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void unsetSite()
    {
        ...
        else
        {
            ...
            siteESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE,
                                                null, null, oldSiteESet ) );
        }
    }
    ...
    public NotificationChain basicSetRelocation( Relocation newRelocation, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION,
    ...
    public void setRelocation( Relocation newRelocation )
    {
        if ( newRelocation != relocation )
        {
            ...
            if ( relocation != null )
                msgs =
                    ( (InternalEObject) relocation ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, null, msgs );
            if ( newRelocation != null )
                msgs =
                    ( (InternalEObject) newRelocation ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, null, msgs );
    ...
    public NotificationChain basicUnsetRelocation( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION,
    ...
    public void unsetRelocation()
    {
        ...
        else
        {
            ...
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                                                PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, null, null,
                                                oldRelocationESet ) );
        }
    }
