 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getSnapshotRepository <em>Snapshot Repository</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getSite <em>Site</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getDownloadUrl <em>Download Url</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getRelocation <em>Relocation</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DistributionManagementImpl#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DistributionManagementImpl extends EObjectImpl implements DistributionManagement
{
    ...
    public NotificationChain basicSetRepository(DeploymentRepository newRepository, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, oldRepository, newRepository, !oldRepositoryESet);
    ...
    public void setRepository(DeploymentRepository newRepository)
    {
        ...
        else
        {
            ...
            repositoryESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, newRepository, newRepository, !oldRepositoryESet));
        }
    }
    ...
    public NotificationChain basicUnsetRepository(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, oldRepository, null, oldRepositoryESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetRepository()
    {
        ...
        else
        {
            ...
            repositoryESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__REPOSITORY, null, null, oldRepositoryESet));
        }
    }
    ...
    public NotificationChain basicSetSnapshotRepository(DeploymentRepository newSnapshotRepository, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, oldSnapshotRepository, newSnapshotRepository, !oldSnapshotRepositoryESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setSnapshotRepository(DeploymentRepository newSnapshotRepository)
    {
        ...
        else
        {
            ...
            snapshotRepositoryESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, newSnapshotRepository, newSnapshotRepository, !oldSnapshotRepositoryESet));
        }
    }
    ...
    public NotificationChain basicUnsetSnapshotRepository(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, oldSnapshotRepository, null, oldSnapshotRepositoryESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetSnapshotRepository()
    {
        ...
        else
        {
            ...
            snapshotRepositoryESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SNAPSHOT_REPOSITORY, null, null, oldSnapshotRepositoryESet));
        }
    }
    ...
    public NotificationChain basicSetSite(Site newSite, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, oldSite, newSite, !oldSiteESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setSite(Site newSite)
    {
        ...
        else
        {
            ...
            siteESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, newSite, newSite, !oldSiteESet));
        }
    }
    ...
    public NotificationChain basicUnsetSite(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, oldSite, null, oldSiteESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetSite()
    {
        ...
        else
        {
            ...
            siteESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__SITE, null, null, oldSiteESet));
        }
    }
    ...
    public NotificationChain basicSetRelocation(Relocation newRelocation, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, oldRelocation, newRelocation, !oldRelocationESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setRelocation(Relocation newRelocation)
    {
        ...
        else
        {
            ...
            relocationESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, newRelocation, newRelocation, !oldRelocationESet));
        }
    }
    ...
    public NotificationChain basicUnsetRelocation(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, oldRelocation, null, oldRelocationESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetRelocation()
    {
        ...
        else
        {
            ...
            relocationESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DISTRIBUTION_MANAGEMENT__RELOCATION, null, null, oldRelocationESet));
        }
    }
