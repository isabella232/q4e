 ...
 * --> <!-- begin-model-doc --> 4.0.0 This is an activator which will detect an operating system's attributes in order
 * to activate its profile. <!-- end-model-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.ActivationOS#getName <em>Name</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.ActivationOS#getFamily <em>Family</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.ActivationOS#getArch <em>Arch</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.ActivationOS#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.devzuz.q.maven.pom.PomPackage#getActivationOS()
    ...
    extends EObject
{
     ...
     * <!-- begin-model-doc --> 4.0.0 The name of the operating system to be used to activate the profile. This must be
     * an exact match of the &lt;code&gt;${os.name}&lt;/code&gt; Java property, such as &lt;code&gt;Windows
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='family'
     *        namespace='##targetNamespace'"
     * @generated
     */
    String getFamily();
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='arch'
     *        namespace='##targetNamespace'"
     * @generated
     */
    String getArch();
