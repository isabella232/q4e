...
import org.devzuz.q.maven.pom.ConfigurationType3;
 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginExecutionImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginExecutionImpl#getPhase <em>Phase</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginExecutionImpl#getGoals <em>Goals</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginExecutionImpl#getInherited <em>Inherited</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.PluginExecutionImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginExecutionImpl extends EObjectImpl implements PluginExecution
{
    ...
    public NotificationChain basicSetGoals(GoalsType1 newGoals, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.PLUGIN_EXECUTION__GOALS, oldGoals, newGoals, !oldGoalsESet);
    ...
    public void setGoals(GoalsType1 newGoals)
    {
        ...
        else
        {
            ...
            goalsESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.PLUGIN_EXECUTION__GOALS, newGoals, newGoals, !oldGoalsESet));
        }
    }
    ...
    public NotificationChain basicUnsetGoals(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.PLUGIN_EXECUTION__GOALS, oldGoals, null, oldGoalsESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetGoals()
    {
        ...
        else
        {
            ...
            goalsESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.PLUGIN_EXECUTION__GOALS, null, null, oldGoalsESet));
        }
    }
    ...
    public NotificationChain basicSetConfiguration(ConfigurationType3 newConfiguration, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.PLUGIN_EXECUTION__CONFIGURATION, oldConfiguration, newConfiguration, !oldConfigurationESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setConfiguration(ConfigurationType3 newConfiguration)
    {
        ...
        else
        {
            ...
            configurationESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.PLUGIN_EXECUTION__CONFIGURATION, newConfiguration, newConfiguration, !oldConfigurationESet));
        }
    }
    ...
    public NotificationChain basicUnsetConfiguration(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.PLUGIN_EXECUTION__CONFIGURATION, oldConfiguration, null, oldConfigurationESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetConfiguration()
    {
        ...
        else
        {
            ...
            configurationESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.PLUGIN_EXECUTION__CONFIGURATION, null, null, oldConfigurationESet));
        }
    }
