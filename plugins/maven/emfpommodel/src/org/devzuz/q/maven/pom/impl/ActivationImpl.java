 ...
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.impl.ActivationImpl#isActiveByDefault <em>Active By Default</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ActivationImpl#getJdk <em>Jdk</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ActivationImpl#getOs <em>Os</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ActivationImpl#getProperty <em>Property</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.ActivationImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
    ...
    implements Activation
{
    ...
    public NotificationChain basicSetOs( ActivationOS newOs, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.ACTIVATION__OS, oldOs, newOs, !oldOsESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setOs( ActivationOS newOs )
    {
        if ( newOs != os )
        {
            ...
            if ( os != null )
                msgs =
                    ( (InternalEObject) os ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.ACTIVATION__OS,
                                                             null, msgs );
            if ( newOs != null )
                msgs =
                    ( (InternalEObject) newOs ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE - PomPackage.ACTIVATION__OS,
                                                             null, msgs );
    ...
    public NotificationChain basicUnsetOs( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.ACTIVATION__OS, oldOs, null, oldOsESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetOs()
    {
        ...
        else
        {
            ...
            osESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.ACTIVATION__OS, null, null,
                                                oldOsESet ) );
        }
    }
    ...
    public NotificationChain basicSetProperty( ActivationProperty newProperty, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.ACTIVATION__PROPERTY, oldProperty,
    ...
    public void setProperty( ActivationProperty newProperty )
    {
        if ( newProperty != property )
        {
            ...
            if ( property != null )
                msgs =
                    ( (InternalEObject) property ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.ACTIVATION__PROPERTY, null, msgs );
            if ( newProperty != null )
                msgs =
                    ( (InternalEObject) newProperty ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.ACTIVATION__PROPERTY, null, msgs );
    ...
    public NotificationChain basicUnsetProperty( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.ACTIVATION__PROPERTY, oldProperty, null,
                                       oldPropertyESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicSetFile( ActivationFile newFile, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.ACTIVATION__FILE, oldFile, newFile,
                                       !oldFileESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setFile( ActivationFile newFile )
    {
        if ( newFile != file )
        {
            ...
            if ( file != null )
                msgs =
                    ( (InternalEObject) file ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.ACTIVATION__FILE, null, msgs );
            if ( newFile != null )
                msgs =
                    ( (InternalEObject) newFile ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.ACTIVATION__FILE, null, msgs );
    ...
    public NotificationChain basicUnsetFile( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.ACTIVATION__FILE, oldFile, null,
                                       oldFileESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void unsetFile()
    {
        if ( file != null )
        {
            NotificationChain msgs = null;
            msgs =
                ( (InternalEObject) file ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.ACTIVATION__FILE,
                                                           null, msgs );
        ...
        else
        {
            ...
            fileESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.ACTIVATION__FILE, null, null,
                                                oldFileESet ) );
        }
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType )
    {
        switch ( featureID )
        {
            case PomPackage.ACTIVATION__ACTIVE_BY_DEFAULT:
                return isActiveByDefault() ? Boolean.TRUE : Boolean.FALSE;
    ...
    public void eSet( int featureID, Object newValue )
    {
        ...
        {
            case PomPackage.ACTIVATION__ACTIVE_BY_DEFAULT:
                setActiveByDefault( ( (Boolean) newValue ).booleanValue() );
                return;
            case PomPackage.ACTIVATION__JDK:
