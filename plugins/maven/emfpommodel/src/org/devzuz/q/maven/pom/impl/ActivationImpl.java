...
public class ActivationImpl extends EObjectImpl implements Activation
{
    ...
    public NotificationChain basicSetOs(ActivationOS newOs, NotificationChain msgs)
    {
		...
		osESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.ACTIVATION__OS, oldOs, newOs, !oldOsESet);
    ...
    public NotificationChain basicUnsetOs(NotificationChain msgs)
    {
		...
		osESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.ACTIVATION__OS, oldOs, null, oldOsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public NotificationChain basicSetProperty(ActivationProperty newProperty, NotificationChain msgs)
    {
		...
		propertyESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.ACTIVATION__PROPERTY, oldProperty, newProperty, !oldPropertyESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setProperty(ActivationProperty newProperty)
    {
		if (newProperty != property) {
			...
			propertyESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.ACTIVATION__PROPERTY, newProperty, newProperty, !oldPropertyESet));
		}
	}
    ...
    public NotificationChain basicUnsetProperty(NotificationChain msgs)
    {
		...
		propertyESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.ACTIVATION__PROPERTY, oldProperty, null, oldPropertyESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void unsetProperty()
    {
		if (property != null) {
			...
			propertyESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.ACTIVATION__PROPERTY, null, null, oldPropertyESet));
		}
	}
    ...
    public NotificationChain basicSetFile(ActivationFile newFile, NotificationChain msgs)
    {
		...
		fileESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.ACTIVATION__FILE, oldFile, newFile, !oldFileESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setFile(ActivationFile newFile)
    {
		if (newFile != file) {
			...
			fileESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.ACTIVATION__FILE, newFile, newFile, !oldFileESet));
		}
	}
    ...
    public NotificationChain basicUnsetFile(NotificationChain msgs)
    {
		...
		fileESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.ACTIVATION__FILE, oldFile, null, oldFileESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
