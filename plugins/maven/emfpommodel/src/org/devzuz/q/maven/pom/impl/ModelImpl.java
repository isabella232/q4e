    ...
    implements Model
{
    ...
    /**
     * This is true if the Issue Management containment reference has been set. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
    ...
    public NotificationChain basicSetParent( Parent newParent, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__PARENT, oldParent, newParent,
                                       !oldParentESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setParent( Parent newParent )
    {
        if ( newParent != parent )
        {
            ...
            if ( parent != null )
                msgs =
                    ( (InternalEObject) parent ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__PARENT, null, msgs );
            if ( newParent != null )
                msgs =
                    ( (InternalEObject) newParent ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__PARENT, null, msgs );
    ...
    public NotificationChain basicUnsetParent( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__PARENT, oldParent, null,
                                       oldParentESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void unsetParent()
    {
        if ( parent != null )
        {
            NotificationChain msgs = null;
            msgs =
                ( (InternalEObject) parent ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__PARENT,
                                                             null, msgs );
        ...
        else
        {
            ...
            parentESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__PARENT, null, null,
                                                oldParentESet ) );
        }
    }
    ...
    public void setPackaging( String newPackaging )
    {
        ...
        packagingESet = true;
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__PACKAGING, oldPackaging,
                                            packaging, !oldPackagingESet ) );
    }
    ...
    public NotificationChain basicSetPrerequisites( Prerequisites newPrerequisites, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__PREREQUISITES, oldPrerequisites,
    ...
    public void setPrerequisites( Prerequisites newPrerequisites )
    {
        if ( newPrerequisites != prerequisites )
        {
            ...
            if ( prerequisites != null )
                msgs =
                    ( (InternalEObject) prerequisites ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__PREREQUISITES, null, msgs );
            if ( newPrerequisites != null )
                msgs =
                    ( (InternalEObject) newPrerequisites ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__PREREQUISITES, null, msgs );
        ...
        else
        {
            ...
            prerequisitesESet = true;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__PREREQUISITES,
                                                newPrerequisites, newPrerequisites, !oldPrerequisitesESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetPrerequisites( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__PREREQUISITES, oldPrerequisites,
                                       null, oldPrerequisitesESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public NotificationChain basicSetIssueManagement( IssueManagement newIssueManagement, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__ISSUE_MANAGEMENT, oldIssueManagement,
    ...
    public void setIssueManagement( IssueManagement newIssueManagement )
    {
        if ( newIssueManagement != issueManagement )
        {
            ...
            if ( issueManagement != null )
                msgs =
                    ( (InternalEObject) issueManagement ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__ISSUE_MANAGEMENT, null, msgs );
            if ( newIssueManagement != null )
                msgs =
                    ( (InternalEObject) newIssueManagement ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__ISSUE_MANAGEMENT, null, msgs );
        ...
        else
        {
            ...
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__ISSUE_MANAGEMENT,
                                                newIssueManagement, newIssueManagement, !oldIssueManagementESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetIssueManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__ISSUE_MANAGEMENT,
    ...
    public void unsetIssueManagement()
    {
        ...
        else
        {
            ...
            issueManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__ISSUE_MANAGEMENT, null,
                                                null, oldIssueManagementESet ) );
        }
    }
    ...
    public NotificationChain basicSetCiManagement( CiManagement newCiManagement, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__CI_MANAGEMENT, oldCiManagement,
    ...
    public void setCiManagement( CiManagement newCiManagement )
    {
        if ( newCiManagement != ciManagement )
        {
            ...
            if ( ciManagement != null )
                msgs =
                    ( (InternalEObject) ciManagement ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__CI_MANAGEMENT, null, msgs );
            if ( newCiManagement != null )
                msgs =
                    ( (InternalEObject) newCiManagement ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__CI_MANAGEMENT, null, msgs );
        ...
        else
        {
            ...
            ciManagementESet = true;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__CI_MANAGEMENT,
                                                newCiManagement, newCiManagement, !oldCiManagementESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetCiManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__CI_MANAGEMENT, oldCiManagement,
                                       null, oldCiManagementESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public EList<MailingList> getMailingLists()
    {
        ...
        {
            mailingLists =
                new EObjectContainmentEList.Unsettable<MailingList>( MailingList.class, this,
    ...
    public EList<Developer> getDevelopers()
    {
        ...
        {
            developers =
                new EObjectContainmentEList.Unsettable<Developer>( Developer.class, this, PomPackage.MODEL__DEVELOPERS );
        }
        return developers;
    }
    ...
    public EList<Contributor> getContributors()
    {
        ...
        {
            contributors =
                new EObjectContainmentEList.Unsettable<Contributor>( Contributor.class, this,
    ...
    public NotificationChain basicSetScm( Scm newScm, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__SCM, oldScm, newScm, !oldScmESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void setScm( Scm newScm )
    {
        if ( newScm != scm )
        {
            ...
            if ( scm != null )
                msgs =
                    ( (InternalEObject) scm ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__SCM,
                                                              null, msgs );
            if ( newScm != null )
                msgs =
                    ( (InternalEObject) newScm ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__SCM,
                                                              null, msgs );
    ...
    public NotificationChain basicUnsetScm( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__SCM, oldScm, null, oldScmESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetScm()
    {
        if ( scm != null )
        {
            NotificationChain msgs = null;
            msgs =
                ( (InternalEObject) scm ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__SCM, null,
                                                          msgs );
    ...
    public NotificationChain basicSetOrganization( Organization newOrganization, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__ORGANIZATION, oldOrganization,
    ...
    public void setOrganization( Organization newOrganization )
    {
        if ( newOrganization != organization )
        {
            ...
            if ( organization != null )
                msgs =
                    ( (InternalEObject) organization ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__ORGANIZATION, null, msgs );
            if ( newOrganization != null )
                msgs =
                    ( (InternalEObject) newOrganization ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__ORGANIZATION, null, msgs );
        ...
        else
        {
            ...
            organizationESet = true;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__ORGANIZATION,
                                                newOrganization, newOrganization, !oldOrganizationESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetOrganization( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__ORGANIZATION, oldOrganization, null,
                                       oldOrganizationESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicSetBuild( Build newBuild, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__BUILD, oldBuild, newBuild,
                                       !oldBuildESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setBuild( Build newBuild )
    {
        if ( newBuild != build )
        {
            ...
            if ( build != null )
                msgs =
                    ( (InternalEObject) build ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__BUILD,
                                                                null, msgs );
            if ( newBuild != null )
                msgs =
                    ( (InternalEObject) newBuild ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE - PomPackage.MODEL__BUILD,
                                                                null, msgs );
    ...
    public NotificationChain basicUnsetBuild( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__BUILD, oldBuild, null, oldBuildESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetBuild()
    {
        ...
        else
        {
            ...
            buildESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__BUILD, null, null,
                                                oldBuildESet ) );
        }
    }
    ...
    public EList<Profile> getProfiles()
    {
        ...
        {
            profiles =
                new EObjectContainmentEList.Unsettable<Profile>( Profile.class, this, PomPackage.MODEL__PROFILES );
        }
        return profiles;
    }
    ...
    public EList<Repository> getRepositories()
    {
        ...
        {
            repositories =
                new EObjectContainmentEList.Unsettable<Repository>( Repository.class, this,
    ...
    public EList<Dependency> getDependencies()
    {
        ...
        {
            dependencies =
                new EObjectContainmentEList.Unsettable<Dependency>( Dependency.class, this,
    ...
    public NotificationChain basicSetReporting( Reporting newReporting, NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__REPORTING, oldReporting, newReporting,
                                       !oldReportingESet );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setReporting( Reporting newReporting )
    {
        if ( newReporting != reporting )
        {
            ...
            if ( reporting != null )
                msgs =
                    ( (InternalEObject) reporting ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__REPORTING, null, msgs );
            if ( newReporting != null )
                msgs =
                    ( (InternalEObject) newReporting ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__REPORTING, null, msgs );
    ...
    public NotificationChain basicUnsetReporting( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__REPORTING, oldReporting, null,
                                       oldReportingESet );
            if ( msgs == null )
                msgs = notification;
            else
                                                           ...
                                                           NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__DEPENDENCY_MANAGEMENT,
                                       oldDependencyManagement, newDependencyManagement, !oldDependencyManagementESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void setDependencyManagement( DependencyManagement newDependencyManagement )
    {
        if ( newDependencyManagement != dependencyManagement )
        {
            ...
            if ( dependencyManagement != null )
                msgs =
                    ( (InternalEObject) dependencyManagement ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__DEPENDENCY_MANAGEMENT, null, msgs );
            if ( newDependencyManagement != null )
                msgs =
                    ( (InternalEObject) newDependencyManagement ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__DEPENDENCY_MANAGEMENT, null, msgs );
    ...
    public NotificationChain basicUnsetDependencyManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__DEPENDENCY_MANAGEMENT,
    ...
    public void unsetDependencyManagement()
    {
        ...
        else
        {
            ...
            dependencyManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__DEPENDENCY_MANAGEMENT,
                                                null, null, oldDependencyManagementESet ) );
        }
    }
                                                             ...
                                                             NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.MODEL__DISTRIBUTION_MANAGEMENT,
    ...
    public void setDistributionManagement( DistributionManagement newDistributionManagement )
    {
        if ( newDistributionManagement != distributionManagement )
        {
            ...
            if ( distributionManagement != null )
                msgs =
                    ( (InternalEObject) distributionManagement ).eInverseRemove( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__DISTRIBUTION_MANAGEMENT, null, msgs );
            if ( newDistributionManagement != null )
                msgs =
                    ( (InternalEObject) newDistributionManagement ).eInverseAdd( this, EOPPOSITE_FEATURE_BASE
                        - PomPackage.MODEL__DISTRIBUTION_MANAGEMENT, null, msgs );
    ...
    public NotificationChain basicUnsetDistributionManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__DISTRIBUTION_MANAGEMENT,
                                       oldDistributionManagement, null, oldDistributionManagementESet );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetDistributionManagement()
    {
        ...
        else
        {
            ...
            distributionManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.MODEL__DISTRIBUTION_MANAGEMENT,
                                                null, null, oldDistributionManagementESet ) );
        }
    }
    ...
    public EList<PropertyElement> getProperties()
    {
        ...
        {
            properties =
                new EObjectContainmentEList.Unsettable<PropertyElement>( PropertyElement.class, this,
    ...
    public EList<String> getModules()
    {
        if ( modules == null )
        {
            modules = new EDataTypeUniqueEList<String>( String.class, this, PomPackage.MODEL__MODULES );
        }
        return modules;
    }
