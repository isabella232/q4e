    ...
    implements Developer
{
    ...
    public void setOrganization( String newOrganization )
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.DEVELOPER__ORGANIZATION,
    ...
    public EList<String> getRoles()
    {
        if ( roles == null )
        {
            roles = new EDataTypeUniqueEList.Unsettable<String>( String.class, this, PomPackage.DEVELOPER__ROLES );
        }
        return roles;
    }
