...
import org.devzuz.q.maven.pom.PropertiesType3;
 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getOrganizationUrl <em>Organization Url</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getRoles <em>Roles</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getTimezone <em>Timezone</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DeveloperImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeveloperImpl extends EObjectImpl implements Developer
{
    ...
    public NotificationChain basicSetRoles(RolesType1 newRoles, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DEVELOPER__ROLES, oldRoles, newRoles, !oldRolesESet);
    ...
    public void setRoles(RolesType1 newRoles)
    {
        ...
        else
        {
            ...
            rolesESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DEVELOPER__ROLES, newRoles, newRoles, !oldRolesESet));
        }
    }
    ...
    public NotificationChain basicUnsetRoles(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DEVELOPER__ROLES, oldRoles, null, oldRolesESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetRoles()
    {
        ...
        else
        {
            ...
            rolesESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DEVELOPER__ROLES, null, null, oldRolesESet));
        }
    }
    ...
    public NotificationChain basicSetProperties(PropertiesType3 newProperties, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DEVELOPER__PROPERTIES, oldProperties, newProperties, !oldPropertiesESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setProperties(PropertiesType3 newProperties)
    {
        ...
        else
        {
            ...
            propertiesESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DEVELOPER__PROPERTIES, newProperties, newProperties, !oldPropertiesESet));
        }
    }
    ...
    public NotificationChain basicUnsetProperties(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DEVELOPER__PROPERTIES, oldProperties, null, oldPropertiesESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetProperties()
    {
        ...
        else
        {
            ...
            propertiesESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DEVELOPER__PROPERTIES, null, null, oldPropertiesESet));
        }
    }
