    ...
    implements ReportPlugin
{
    ...
    public void setArtifactId( String newArtifactId )
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.REPORT_PLUGIN__ARTIFACT_ID,
    ...
    public EList<ReportSet> getReportSets()
    {
        ...
        {
            reportSets =
                new EObjectContainmentEList.Unsettable<ReportSet>( ReportSet.class, this,
