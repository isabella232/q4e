...
public class PomFactoryImpl extends EFactoryImpl implements PomFactory
{
    ...
    public EObject create(EClass eClass)
    {
		switch (eClass.getClassifierID()) {
			...
			case PomPackage.CONFIGURATION_ELEMENT: return createConfigurationElement();
			case PomPackage.PROPERTIES: return createProperties();
			case PomPackage.PROPERTY_ELEMENT: return createPropertyElement();
			case PomPackage.CONFIGURATION: return createConfiguration();
			default:
