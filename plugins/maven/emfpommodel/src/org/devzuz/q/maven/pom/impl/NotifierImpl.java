 ...
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#getType <em>Type</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#isSendOnError <em>Send On Error</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#isSendOnFailure <em>Send On Failure</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#isSendOnSuccess <em>Send On Success</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#isSendOnWarning <em>Send On Warning</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.impl.NotifierImpl#getAddress <em>Address</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
    ...
    implements Notifier
{
    ...
    public void unsetType()
    {
        ...
        typeESet = false;
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.NOTIFIER__TYPE, oldType,
    ...
    public void unsetSendOnError()
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.NOTIFIER__SEND_ON_ERROR,
                                            oldSendOnError, SEND_ON_ERROR_EDEFAULT, oldSendOnErrorESet ) );
    }
