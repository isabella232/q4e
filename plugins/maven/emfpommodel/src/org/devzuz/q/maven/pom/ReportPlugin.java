    ...
    extends EObject
{
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.ReportPlugin#getGroupId <em>Group Id</em>}'
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.ReportPlugin#getArtifactId <em>Artifact Id</em>}'
     ...
     * --> <!-- begin-model-doc --> 4.0.0 Whether the configuration in this plugin should be made available to projects
     * that inherit from this one. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Report Sets</b></em>' containment reference list. The list contents are of
     * type {@link org.devzuz.q.maven.pom.ReportSet}. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     ...
     * @model containment="true" unsettable="true" extendedMetaData="kind='element' name='reportSets'
     *        namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.ReportPlugin#getReportSets <em>Report Sets</em>}'
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.ReportPlugin#getReportSets <em>Report Sets</em>}'
