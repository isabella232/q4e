    ...
    implements BuildBase
{
    ...
    public void setDefaultGoal( String newDefaultGoal )
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.BUILD_BASE__DEFAULT_GOAL,
                                            oldDefaultGoal, defaultGoal ) );
    }
    ...
    public NotificationChain basicSetPluginManagement( PluginManagement newPluginManagement, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired() )
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.SET, PomPackage.BUILD_BASE__PLUGIN_MANAGEMENT,
    ...
    public NotificationChain basicUnsetPluginManagement( NotificationChain msgs )
    {
        ...
        {
            ENotificationImpl notification =
                new ENotificationImpl( this, Notification.UNSET, PomPackage.BUILD_BASE__PLUGIN_MANAGEMENT,
    ...
    public void unsetPluginManagement()
    {
        ...
        else
        {
            ...
            pluginManagementESet = false;
            if ( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, PomPackage.BUILD_BASE__PLUGIN_MANAGEMENT,
                                                null, null, oldPluginManagementESet ) );
        }
    }
    ...
    public EList<Plugin> getPlugins()
    {
        ...
        {
            plugins =
                new EObjectContainmentEList.Unsettable<Plugin>( Plugin.class, this, PomPackage.BUILD_BASE__PLUGINS );
        }
        return plugins;
    }
    ...
    public EList<String> getFilters()
    {
        if ( filters == null )
        {
            filters = new EDataTypeUniqueEList<String>( String.class, this, PomPackage.BUILD_BASE__FILTERS );
        }
        return filters;
    }
