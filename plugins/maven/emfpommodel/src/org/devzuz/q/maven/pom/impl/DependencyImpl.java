 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getSystemPath <em>System Path</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#getExclusions <em>Exclusions</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.DependencyImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyImpl extends EObjectImpl implements Dependency
{
    ...
    /**
	 * This is true if the Exclusions containment reference has been set.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
    protected boolean exclusionsESet;
    ...
    public NotificationChain basicSetExclusions(ExclusionsType newExclusions, NotificationChain msgs)
    {
		...
		boolean oldExclusionsESet = exclusionsESet;
		exclusionsESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DEPENDENCY__EXCLUSIONS, oldExclusions, newExclusions, !oldExclusionsESet);
    ...
    public void setExclusions(ExclusionsType newExclusions)
    {
		if (newExclusions != exclusions) {
			...
			exclusionsESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DEPENDENCY__EXCLUSIONS, newExclusions, newExclusions, !oldExclusionsESet));
		}
	}
	 ...
	 * @generated
	 */
    public NotificationChain basicUnsetExclusions(NotificationChain msgs)
    {
		ExclusionsType oldExclusions = exclusions;
		exclusions = null;
		boolean oldExclusionsESet = exclusionsESet;
		exclusionsESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.DEPENDENCY__EXCLUSIONS, oldExclusions, null, oldExclusionsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void unsetExclusions()
    {
		if (exclusions != null) {
			NotificationChain msgs = null;
			msgs = ((InternalEObject)exclusions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PomPackage.DEPENDENCY__EXCLUSIONS, null, msgs);
			msgs = basicUnsetExclusions(msgs);
			if (msgs != null) msgs.dispatch();
		}
		else {
			boolean oldExclusionsESet = exclusionsESet;
			exclusionsESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.DEPENDENCY__EXCLUSIONS, null, null, oldExclusionsESet));
		}
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
		switch (featureID) {
			case PomPackage.DEPENDENCY__EXCLUSIONS:
				return basicUnsetExclusions(msgs);
		}
