 ...
 * <ul>
 * <li>{@link org.devzuz.q.maven.pom.DocumentRoot#getMixed <em>Mixed</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 * <li>{@link org.devzuz.q.maven.pom.DocumentRoot#getProject <em>Project</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.devzuz.q.maven.pom.PomPackage#getDocumentRoot()
    ...
    extends EObject
{
     ...
     * @see org.devzuz.q.maven.pom.PomPackage#getDocumentRoot_Mixed()
     ...
     * @see org.devzuz.q.maven.pom.PomPackage#getDocumentRoot_XMLNSPrefixMap()
     ...
     * @see org.devzuz.q.maven.pom.PomPackage#getDocumentRoot_XSISchemaLocation()
     * @model mapType="org.eclipse.emf.ecore.EStringToStringMapEntry<org.eclipse.emf.ecore.EString,
     ...
     * end-user-doc --> <!-- begin-model-doc --> 3.0.0+ The &lt;code&gt;&amp;lt;project&amp;gt;&lt;/code&gt; element is
     * the root of the descriptor. The following table lists all of the possible child elements. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Project</em>' containment reference.
     * @see #setProject(Model)
     * @see org.devzuz.q.maven.pom.PomPackage#getDocumentRoot_Project()
    ...
    /**
     * Sets the value of the '{@link org.devzuz.q.maven.pom.DocumentRoot#getProject <em>Project</em>}' containment
