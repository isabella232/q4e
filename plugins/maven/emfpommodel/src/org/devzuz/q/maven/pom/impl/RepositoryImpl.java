 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getReleases <em>Releases</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getSnapshots <em>Snapshots</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.RepositoryImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoryImpl extends EObjectImpl implements Repository
{
    ...
    public NotificationChain basicSetReleases(RepositoryPolicy newReleases, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.REPOSITORY__RELEASES, oldReleases, newReleases, !oldReleasesESet);
    ...
    public void setReleases(RepositoryPolicy newReleases)
    {
        ...
        else
        {
            ...
            releasesESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.REPOSITORY__RELEASES, newReleases, newReleases, !oldReleasesESet));
        }
    }
    ...
    public NotificationChain basicUnsetReleases(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.REPOSITORY__RELEASES, oldReleases, null, oldReleasesESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetReleases()
    {
        ...
        else
        {
            ...
            releasesESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.REPOSITORY__RELEASES, null, null, oldReleasesESet));
        }
    }
    ...
    public NotificationChain basicSetSnapshots(RepositoryPolicy newSnapshots, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.REPOSITORY__SNAPSHOTS, oldSnapshots, newSnapshots, !oldSnapshotsESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setSnapshots(RepositoryPolicy newSnapshots)
    {
        ...
        else
        {
            ...
            snapshotsESet = true;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.REPOSITORY__SNAPSHOTS, newSnapshots, newSnapshots, !oldSnapshotsESet));
        }
    }
    ...
    public NotificationChain basicUnsetSnapshots(NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.REPOSITORY__SNAPSHOTS, oldSnapshots, null, oldSnapshotsESet);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void unsetSnapshots()
    {
        ...
        else
        {
            ...
            snapshotsESet = false;
            if (eNotificationRequired())
                eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.REPOSITORY__SNAPSHOTS, null, null, oldSnapshotsESet));
        }
    }
