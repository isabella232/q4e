    ...
    extends EObject
{
     ...
     * <!-- begin-model-doc --> 4.0.0 The name of the continuous integration system, e.g.
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='element' name='system'
     ...
     * begin-model-doc --> 4.0.0 URL for the continuous integration system used by the project if it has a web
    ...
    /**
     * Returns the value of the '<em><b>Notifiers</b></em>' containment reference list. The list contents are of
     * type {@link org.devzuz.q.maven.pom.Notifier}. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc
     * --> 4.0.0 Configuration for notifying developers/users when a build is unsuccessful, including user information
     * and notification mode. <!-- end-model-doc -->
     * 
     ...
     * @model containment="true" unsettable="true" extendedMetaData="kind='element' name='notifiers'
     *        namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Unsets the value of the '{@link org.devzuz.q.maven.pom.CiManagement#getNotifiers <em>Notifiers</em>}'
    ...
    /**
     * Returns whether the value of the '{@link org.devzuz.q.maven.pom.CiManagement#getNotifiers <em>Notifiers</em>}'
