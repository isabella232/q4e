 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getSubscribe <em>Subscribe</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getUnsubscribe <em>Unsubscribe</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getPost <em>Post</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getArchive <em>Archive</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.MailingListImpl#getOtherArchives <em>Other Archives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MailingListImpl extends EObjectImpl implements MailingList
{
    ...
    /**
	 * This is true if the Other Archives containment reference has been set.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
    protected boolean otherArchivesESet;
    ...
    public NotificationChain basicSetOtherArchives(OtherArchivesType newOtherArchives, NotificationChain msgs)
    {
		...
		boolean oldOtherArchivesESet = otherArchivesESet;
		otherArchivesESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.MAILING_LIST__OTHER_ARCHIVES, oldOtherArchives, newOtherArchives, !oldOtherArchivesESet);
    ...
    public void setOtherArchives(OtherArchivesType newOtherArchives)
    {
		if (newOtherArchives != otherArchives) {
			...
			otherArchivesESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.MAILING_LIST__OTHER_ARCHIVES, newOtherArchives, newOtherArchives, !oldOtherArchivesESet));
		}
	}
	 ...
	 * @generated
	 */
    public NotificationChain basicUnsetOtherArchives(NotificationChain msgs)
    {
		OtherArchivesType oldOtherArchives = otherArchives;
		otherArchives = null;
		boolean oldOtherArchivesESet = otherArchivesESet;
		otherArchivesESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PomPackage.MAILING_LIST__OTHER_ARCHIVES, oldOtherArchives, null, oldOtherArchivesESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void unsetOtherArchives()
    {
		if (otherArchives != null) {
			NotificationChain msgs = null;
			msgs = ((InternalEObject)otherArchives).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PomPackage.MAILING_LIST__OTHER_ARCHIVES, null, msgs);
			msgs = basicUnsetOtherArchives(msgs);
			if (msgs != null) msgs.dispatch();
		}
		else {
			boolean oldOtherArchivesESet = otherArchivesESet;
			otherArchivesESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.MAILING_LIST__OTHER_ARCHIVES, null, null, oldOtherArchivesESet));
		}
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
		switch (featureID) {
			case PomPackage.MAILING_LIST__OTHER_ARCHIVES:
				return basicUnsetOtherArchives(msgs);
		}
