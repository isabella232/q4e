    ...
    implements MailingList
{
    ...
    /**
     * The default value of the '{@link #getPost() <em>Post</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getPost()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getOtherArchives() <em>Other Archives</em>}' attribute list. <!--
    ...
    public void setUnsubscribe( String newUnsubscribe )
    {
        ...
        if ( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, PomPackage.MAILING_LIST__UNSUBSCRIBE,
                                            oldUnsubscribe, unsubscribe ) );
    }
    ...
    public EList<String> getOtherArchives()
    {
        ...
        {
            otherArchives =
                new EDataTypeUniqueEList<String>( String.class, this, PomPackage.MAILING_LIST__OTHER_ARCHIVES );
        }
    ...
    public boolean eIsSet( int featureID )
    {
        switch ( featureID )
        {
            ...
            case PomPackage.MAILING_LIST__OTHER_ARCHIVES:
                return otherArchives != null && !otherArchives.isEmpty();
        }
