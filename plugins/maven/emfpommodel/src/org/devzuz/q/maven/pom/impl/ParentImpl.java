 ...
 * <ul>
 *   <li>{@link org.devzuz.q.maven.pom.impl.ParentImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.ParentImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.ParentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.devzuz.q.maven.pom.impl.ParentImpl#getRelativePath <em>Relative Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParentImpl extends EObjectImpl implements Parent
{
     ...
     * @ordered
     */
    protected static final String RELATIVE_PATH_EDEFAULT = "";
    ...
    public void setRelativePath(String newRelativePath)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.PARENT__RELATIVE_PATH, oldRelativePath, relativePath));
    }
