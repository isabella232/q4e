 ...
 * 
 * Each translator adaptor is expected to have a single root element that controls
 * its existence.  It is responsible for the subtree of that node by updating it directly 
 * or delegating to child adapters to do the work.
 * 
 * 
    ...
    implements INodeAdapter
{
     ...
     * @param oldValue
     */
    public abstract void update( Object oldValue );
