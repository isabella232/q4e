...
public class Maven2ImportArtifactWizardPage extends Maven2ValidatingWizardPage
{
    ...
    public Maven2ImportArtifactWizardPage()
    {
    ...
    public void createControl( final Composite parent )
    {
        ...
        final Group advanceGroup = new Group( container , SWT.BORDER );
