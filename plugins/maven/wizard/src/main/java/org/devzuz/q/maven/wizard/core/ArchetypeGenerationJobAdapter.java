...
public class ArchetypeGenerationJobAdapter extends MavenExecutionJobAdapter
{
     ...
     * @param importParentEnabled
     *            <code>true</code> if parent projects should be imported, <code>false</code> otherwise.
     * @param wizardContext
    ...
    public void done( IJobChangeEvent event, IMavenExecutionResult result )
    {
        ...
        job.addJobChangeListener( new JobChangeAdapter()
        {
            ...
            public void done( IJobChangeEvent event )
            {
                ...
                {
                    List<IProject> pomDescriptors = ( (ScanImportProjectJob) event.getJob() ).getImportedProjects();
