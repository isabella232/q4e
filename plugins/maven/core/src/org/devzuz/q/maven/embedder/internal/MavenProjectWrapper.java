...
/**
 * Subclass of the standard {@link MavenProject} which adds functionality to resolve classpath entries from projects in
 * the workspace.
 * 
 * @author amuino
 */
...
public class MavenProjectWrapper extends MavenProject implements Cloneable
{
    ...
    /**
     * Implementation copied from {@link MavenProject#getCompileClasspathElements()} and modified to expand references
     * to pom.xml.
     */
    @Override
