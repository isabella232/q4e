...
public interface IMaven
{
    ...
    /**
     * Returns the file object pointing to the packaged artifact generated by the given project. Note that no packaging
     * is performed by this method, so the file might not actually exist.
     * 
     * <em>Note: </em> This method is needed at the maven level because knowing the extension requires diving in the
     * plexus container.
     * 
     * @param project
     *            the project to get the packaged artifact file for.
     * @return the file object representing the packaged artifact. Might not exist.
     */
