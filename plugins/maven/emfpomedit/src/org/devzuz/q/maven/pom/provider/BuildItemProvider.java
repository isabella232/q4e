...
/**
 * This is the item provider adapter for a {@link org.devzuz.q.maven.pom.Build} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
    ...
    IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addSourceDirectoryPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Build_sourceDirectory_feature",
                                                                              "_UI_Build_type" ),
                                                                   PomPackage.Literals.BUILD__SOURCE_DIRECTORY, true,
                                                                   false, false,
    ...
    /**
     * This adds a property descriptor for the Script Source Directory feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    protected void addOutputDirectoryPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Build_outputDirectory_feature",
                                                                              "_UI_Build_type" ),
                                                                   PomPackage.Literals.BUILD__OUTPUT_DIRECTORY, true,
                                                                   false, false,
                                                                   ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
                                                                   null ) );
    }
    ...
    protected void addDefaultGoalPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Build_defaultGoal_feature",
                                                                              "_UI_Build_type" ),
                                                                   PomPackage.Literals.BUILD__DEFAULT_GOAL, true,
                                                                   false, false,
                                                                   ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
                                                                   null ) );
    }
    ...
    protected void addDirectoryPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Build_directory_feature",
                                                                              "_UI_Build_type" ),
                                                                   PomPackage.Literals.BUILD__DIRECTORY, true, false,
    ...
    protected void addFinalNamePropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Build_finalName_feature",
                                                                              "_UI_Build_type" ),
                                                                   PomPackage.Literals.BUILD__FINAL_NAME, true, false,
                                                                   false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                                                                   null, null ) );
    }
    ...
    protected void collectNewChildDescriptors( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add( createChildParameter( PomPackage.Literals.BUILD__RESOURCES,
                                                       PomFactory.eINSTANCE.createResource() ) );

        newChildDescriptors.add( createChildParameter( PomPackage.Literals.BUILD__TEST_RESOURCES,
                                                       PomFactory.eINSTANCE.createResource() ) );

        newChildDescriptors.add( createChildParameter( PomPackage.Literals.BUILD__PLUGIN_MANAGEMENT,
                                                       PomFactory.eINSTANCE.createPluginManagement() ) );

        newChildDescriptors.add( createChildParameter( PomPackage.Literals.BUILD__PLUGINS,
                                                       PomFactory.eINSTANCE.createPlugin() ) );

        newChildDescriptors.add( createChildParameter( PomPackage.Literals.BUILD__FILTERS, "" ) );
    }
    ...
    public String getCreateChildText( Object owner, Object feature, Object child, Collection<?> selection )
    {
        ...
        boolean qualify =
            childFeature == PomPackage.Literals.BUILD__RESOURCES
                || childFeature == PomPackage.Literals.BUILD__TEST_RESOURCES;
