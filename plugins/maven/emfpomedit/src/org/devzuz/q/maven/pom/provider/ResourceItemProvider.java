...
/**
 * This is the item provider adapter for a {@link org.devzuz.q.maven.pom.Resource} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
    ...
    IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addTargetPathPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              ...
                                                                              "_UI_Resource_type" ),
                                                                   PomPackage.Literals.RESOURCE__TARGET_PATH, true,
                                                                   false, false,
    ...
    protected void addFilteringPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Resource_filtering_feature",
                                                                              "_UI_Resource_type" ),
                                                                   PomPackage.Literals.RESOURCE__FILTERING, true,
                                                                   false, false,
    ...
    protected void addDirectoryPropertyDescriptor( Object object )
    {
        itemPropertyDescriptors.add( createItemPropertyDescriptor(
                                                                   ...
                                                                   getString( "_UI_PropertyDescriptor_description",
                                                                              "_UI_Resource_directory_feature",
                                                                              "_UI_Resource_type" ),
                                                                   PomPackage.Literals.RESOURCE__DIRECTORY, true,
                                                                   false, false,
                                                                   ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
                                                                   null ) );
    }
