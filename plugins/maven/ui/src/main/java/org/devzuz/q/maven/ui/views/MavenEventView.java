...
import org.devzuz.q.maven.ui.dialogs.MavenEventDetailDialog;
...
public class MavenEventView extends ViewPart implements Observer
{
    ...
    public void createPartControl( Composite parent )
    {
        ...
        makeActions();
        addToolbars();
        addTableMenuAndHandlers( eventTable );
    ...
    private void addTableMenuAndHandlers( final Table eventTable )
    {
        ...
        eventTable.addMouseListener( clickedDataItem );
    }
    ...
    private void openEventDetailDialog( final Table eventTable )
    {
        MavenEventDetailDialog dialog = MavenEventDetailDialog.getMavenEventDetailDialog();
        dialog.setEventTable( eventTable );
        dialog.open();
    }
}
